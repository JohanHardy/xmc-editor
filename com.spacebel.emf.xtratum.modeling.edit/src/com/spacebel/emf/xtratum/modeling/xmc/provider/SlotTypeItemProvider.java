...
/**
 * This is the item provider adapter for a {@link com.spacebel.emf.xtratum.modeling.xmc.SlotType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SlotTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SlotType_duration_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SlotType_duration_feature", "_UI_SlotType_type"),
				 XmcPackage.Literals.SLOT_TYPE__DURATION,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 XmcPackage.Literals.SLOT_TYPE__ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPartitionIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SlotType_partitionId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SlotType_partitionId_feature", "_UI_SlotType_type"),
				 XmcPackage.Literals.SLOT_TYPE__PARTITION_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addStartPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SlotType_start_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SlotType_start_feature", "_UI_SlotType_type"),
				 XmcPackage.Literals.SLOT_TYPE__START,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		BigInteger labelValue = ((SlotType)object).getId();
