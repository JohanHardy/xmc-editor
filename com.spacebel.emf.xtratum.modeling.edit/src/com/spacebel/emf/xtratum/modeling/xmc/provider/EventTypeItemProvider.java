...
/**
 * This is the item provider adapter for a {@link com.spacebel.emf.xtratum.modeling.xmc.EventType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EventType_action_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EventType_action_feature", "_UI_EventType_type"),
				 XmcPackage.Literals.EVENT_TYPE__ACTION,
				 true,
				 false,
				 false,
	...
	protected void addLogPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EventType_log_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EventType_log_feature", "_UI_EventType_type"),
				 XmcPackage.Literals.EVENT_TYPE__LOG,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 XmcPackage.Literals.EVENT_TYPE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		HmStringT labelValue = ((EventType)object).getName();
