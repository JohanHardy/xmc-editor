...
/**
 * This is the item provider adapter for a {@link com.spacebel.emf.xtratum.modeling.xmc.PortType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PortTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PortType_direction_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PortType_direction_feature", "_UI_PortType_type"),
				 XmcPackage.Literals.PORT_TYPE__DIRECTION,
				 true,
				 false,
				 false,
	...
	protected void addDisciplinePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PortType_discipline_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PortType_discipline_feature", "_UI_PortType_type"),
				 XmcPackage.Literals.PORT_TYPE__DISCIPLINE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 XmcPackage.Literals.PORT_TYPE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 XmcPackage.Literals.PORT_TYPE__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		{
			/* Add type of port */
			label += " | " + ((PortType)object).getType().getName();
			label += " - " +  ((PortType)object).getDirection().getName();
		}
		return label;
	}
